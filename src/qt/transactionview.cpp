 ...
 */
    ...
    typeWidget->addItem(tr("Received Malw from zMalw"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMalw"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMalw));
