...
/** Utility functions used by the MalwareChain Qt UI.
 */
namespace GUIUtil
{
...
// Render MalwareChain addresses in monospace font
...
// Parse "malwarechain:" URI into recipient object, return true on successful parsing
