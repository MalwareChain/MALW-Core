...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MALW);
    unitlist.append(mMALW);
    unitlist.append(uMALW);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MALW:
        return QString("malwarechain");
    case mMALW:
        return QString("mmalwarechain");
    case uMALW:
        return QString::fromUtf8("umalwarechain");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MALW:
            return QString("MALW");
        case mMALW:
            return QString("mMALW");
        case uMALW:
            return QString::fromUtf8("μMALW");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MALW:
            return QString("tMALW");
        case mMALW:
            return QString("mtMALW");
        case uMALW:
            return QString::fromUtf8("μtMALW");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MALW:
            return QString("MALW");
        case mMALW:
            return QString("Milli-MALW (1 / 1" THIN_SP_UTF8 "000)");
        case uMALW:
            return QString("Micro-MALW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MALW:
            return QString("TestMALWs");
        case mMALW:
            return QString("Milli-TestMALW (1 / 1" THIN_SP_UTF8 "000)");
        case uMALW:
            return QString("Micro-TestMALW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
