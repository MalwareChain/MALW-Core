                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MalwareChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MalwareChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and malwarechain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMALW"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MalwareChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about MalwareChain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MalwareChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MalwareChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MalwareChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a MalwareChain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MalwareChain Core help message to get a list with possible MalwareChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MalwareChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MalwareChain network", "", count));
}
...
{
    QString strTitle = tr("MalwareChain Core"); // default title
