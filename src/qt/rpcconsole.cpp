                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzmalwPathCustom = GetArg("-zmalwbackuppath", "");
    ...
    if(!strzmalwPathCustom.empty()) {
        ui->wallet_customzmalwbackuppath->setText(QString::fromStdString(strzmalwPathCustom));
        ui->wallet_customzmalwbackuppath_label->setVisible(true);
        ui->wallet_customzmalwbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzmalwPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MalwareChain RPC console.") + "<br>" +
