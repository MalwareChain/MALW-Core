...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MalwareChain Core"),
     ...
     * override -datadir in the malwarechain.conf file in the default data directory
     * (to be consistent with malwarechaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
