...
/**
 * MalwareChain RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzmalwseed(const UniValue& params, bool fHelp);
extern UniValue getzmalwseed(const UniValue& params, bool fHelp);
