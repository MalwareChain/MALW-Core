...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MalwareChain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MalwareChain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MalwareChain features */
        {"malwarechain", "masternode", &masternode, true, true, false},
        {"malwarechain", "listmasternodes", &listmasternodes, true, true, false},
        {"malwarechain", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"malwarechain", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"malwarechain", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"malwarechain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"malwarechain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"malwarechain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"malwarechain", "masternodedebug", &masternodedebug, true, true, false},
        {"malwarechain", "startmasternode", &startmasternode, true, true, false},
        {"malwarechain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"malwarechain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"malwarechain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"malwarechain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"malwarechain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"malwarechain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"malwarechain", "mnbudget", &mnbudget, true, true, false},
        {"malwarechain", "preparebudget", &preparebudget, true, true, false},
        {"malwarechain", "submitbudget", &submitbudget, true, true, false},
        {"malwarechain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"malwarechain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"malwarechain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"malwarechain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"malwarechain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"malwarechain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"malwarechain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"malwarechain", "checkbudgets", &checkbudgets, true, true, false},
        {"malwarechain", "mnsync", &mnsync, true, true, false},
        {"malwarechain", "spork", &spork, true, true, false},
        {"malwarechain", "getpoolinfo", &getpoolinfo, true, true, false},
        {"malwarechain", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzmalwseed", &getzmalwseed, false, false, true},
        {"zerocoin", "setzmalwseed", &setzmalwseed, false, false, true}
...
{
    return "> malwarechain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21104/\n";
}
