...
In order to support loading of multiple wallets in malwarechain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is malwarechain.cpp.
...
Changes to malwarechain.cpp
----------------------
malwarechain.cpp is the entry point into malwarechain-qt, and as such, will require some minor modifications to provide hooks for
