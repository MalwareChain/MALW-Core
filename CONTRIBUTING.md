Contributing to MalwareChain Core
============================

The MalwareChain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MalwareChain Core project, and is not to be
confused with overall MalwareChain Network Protocol consensus changes.

Whether a pull request is merged into MalwareChain Core rests with the project merge
...
Patches that change MalwareChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the MalwareChain consensus, it must have been
...
The project leader is the release manager for each MalwareChain Core release.
