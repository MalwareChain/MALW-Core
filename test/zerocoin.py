...
#   c) node1 mines 32 blocks, so now node 0 has 60001malw, node 1 has 4250malw, node2 has none.
#   d) node0 sends 601 malw to node2, in two transactions (301 malw, then 300 malw).
